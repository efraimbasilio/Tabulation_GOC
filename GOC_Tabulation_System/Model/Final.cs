        ...
        public void Save()
        {
            try
            {
                ...
                using (MySqlConnection con = new MySqlConnection(GOC_Tabulation_System.Config.GetConnectionString()))
                {
                    ...
                    string sql = string.Concat("UPDATE final SET " + "b" + judge + " = @score_beauty, " + "w" + judge + " = @score_wit WHERE can_no=@can_no;");
        ...
        public void Insert_Final_10()
        {
            try
            {
                ...
                using (MySqlConnection con = new MySqlConnection(GOC_Tabulation_System.Config.GetConnectionString()))
                {
                    ...
                    string sql = "INSERT INTO final(can_no,b1,w1,b2,w2,b3,w3,b4,w4,b5,w5,b6,w6,b7,w7,b8,w8,b9,w9,total) " +
